...
export class AuthClient {
  ...
  constructor(address: string, creds?: grpc.ChannelCredentials) {
    ...
    this.client = bindAll(new clientClass(
      address,
  ...
  getUser(clause?: string) {
    return promisify(this.client.ReadOneUser)({
      clause: clause || '',
    }).then(throwOnUndefined)
  }
  ...
  createUser(user: UserCreateData) {
    return promisify(this.client.CreateUser)(user).then(throwOnUndefined)
  }
  ...
  getPermission(clause?: string) {
    return promisify(this.client.ReadOnePermission)({
      clause: clause || '',
    }).then(throwOnUndefined)
  }
  ...
  createPermission(permission: PermissionCreateData) {
    return promisify(this.client.CreatePermission)(permission).then(
      throwOnUndefined,
    )
  }
  ...
  getRole(clause?: string) {
    return promisify(this.client.ReadOneRole)({
      clause: clause || '',
    }).then(throwOnUndefined)
  }
  ...
  createRole(role: RoleCreateData) {
    return promisify(this.client.CreateRole)(role).then(throwOnUndefined)
  }
  ...
  grantPermissionToUser(resource: string, level: Level, accessorId: number) {
    return promisify(this.client.GrantPermissionToUser)({
      resource,
      level,
      accessorId,
    }).then(throwOnUndefined)
  ...
  grantPermissionToRole(resource: string, level: Level, accessorId: number) {
    return promisify(this.client.GrantPermissionToRole)({
      resource,
      level,
      accessorId,
    }).then(throwOnUndefined)
  ...
  revokePermissionFromUser(resource: string, level: Level, accessorId: number) {
    return promisify(this.client.RevokePermissionFromUser)({
      resource,
      level,
      accessorId,
    }).then(throwOnUndefined)
  ...
  revokePermissionFromRole(resource: string, level: Level, accessorId: number) {
    return promisify(this.client.RevokePermissionFromRole)({
      resource,
      level,
      accessorId,
    }).then(throwOnUndefined)
  ...
  loginAs(loginReq: M.LoginAsRequest) {
    return promisify(this.client.LoginAs)(loginReq).then(throwOnUndefined)
  }
}
